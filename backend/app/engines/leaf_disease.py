...
def _asset_path(configured_path: str) -> Path:
    """Resolve bundled assets independently of the process working directory."""
...
def load_class_map() -> dict:
    ...
    if _class_map is None:
        path = _asset_path(settings.DISEASE_CLASS_NAMES_PATH)
    ...
    if _interpreter is None:
        with _lock:
            if _interpreter is None:
                ...
                model_path = _asset_path(settings.DISEASE_MODEL_PATH)
